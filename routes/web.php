    ...
    Route::group(['middleware' => ['auth', 'verified']], function () {
        ...
        Route::group(['middleware' => ['Email2FA']], function () {
            ...
            Route::group(['middleware' => ['permission'], 'prefix' => 'admin'], function () {
                ...
                // Additional Reports (Screenshot Reports)

                Route::get('reports/disbursed_loans', [ReportController::class, 'disbursed_loans'])->name('reports.disbursed_loans');
                Route::get('reports/loans_due_by_date', [ReportController::class, 'loans_due_by_date'])->name('reports.loans_due_by_date');
                Route::get('reports/loans_due_today', [ReportController::class, 'loans_due_today'])->name('reports.loans_due_today');
                Route::get('reports/mpesa_repayments', [ReportController::class, 'mpesa_repayments'])->name('reports.mpesa_repayments');
                Route::get('reports/loan_arrears_hq', [ReportController::class, 'loan_arrears_hq'])->name('reports.loan_arrears_hq');
            });
